      ...
      <div class="col-md-9 personal-info">
        ...
        <form class="form-horizontal" role="form" method="post" action="/cinfomodify">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input type="text" class="size1" value="${customervo.u_addresscode}" id="addr1" name="u_addresscode">
              <button type="button" class="btn1"  onclick="execPostCode();"><i class="fa fa-search"></i> 우편번호 찾기</button>
              <input class="form-control" type="text" value="${customervo.u_addressStreet}" id="addr2" name="u_addressStreet">
              <input class="form-control" type="text" value="${customervo.u_addressDetail}" id="addr3" name="u_addressDetail">
            </div>
          </div>
          <div class="button">
            <p>
