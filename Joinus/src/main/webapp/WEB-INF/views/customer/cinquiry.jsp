    ...
    <div class="form-container">
        <form action="/inquirysubmit" method="post">
            ...
            <div class="form-group">
                ...
                <input class="input" type="text"  id="i_title" name="i_title" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="input" id="u_inquiry" name="u_inquiry" rows="5" required></textarea>
            </div>
            <hr>
            <button class="button" type="submit">문의글 등록</button>
        </form>
    </div>
</div>
