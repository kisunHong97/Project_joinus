    ...
    <div id="login">
        <div id="login_form"><!--로그인 폼-->
            <form action="/storesignup" method="post">
                <h3 class="login" style="letter-spacing:-1px;">스토어 등록</h3>
                <hr>
                <label>
                    <!-- <span>ID</span> -->
                    <p style="text-align: left; font-size:12px; color:#666">Store Name</p>
                    <input type="text" placeholder="스토어 이름" class="size" name="s_name" id="s_name">
                ...
                <input type="text" placeholder="스토어 URL" class="size"  name="s_URL" id="s_URL">
                    <br>
<%--                    <input type="button" onclick="idOverlap()" value="중복확인" class="resultid"/>--%>
                ...
                <label>
                    ...
                    <div class="form-group">
                        <input class="size1"  placeholder="우편번호" name="s_addrCode" id="addr1" type="text" readonly="readonly" >
                        <button type="button" class="btn1"  onclick="execPostCode();"><i class="fa fa-search"></i> 우편번호 찾기</button>
                    </div>
                    <div class="form-group">
                        <input class="size"  placeholder="도로명 주소" name="s_addrStreet" id="addr2" type="text" readonly="readonly" />
                    </div>
                    <div class="form-group">
                        <input class="size" placeholder="상세주소" name="s_addrDetail" id="addr3" type="text"  />
                    </div>

                </label>
                <label>
                    <p style="text-align: left; font-size:12px; color:#666">Store Email </p>
                    <input type="text" placeholder="스토어 이메일" class="size" name="s_email" id="s_email" >
                    <br>
                    <span id="result1" style="font-size: 12px;"></span>
                </label>

                <label>
                    <p style="text-align: left; font-size:12px; color:#666">Store Number </p>
                    <input type="text" placeholder="스토어 연락처" class="size" name="s_phone" id="s_phone" >
                    <br>
                ...
                <label>
                    ...
                    <input type="text" placeholder="스토어 소개글(한줄로)" class="size" name="s_inst" id="s_inst" >
                </label>
                <br>
                <p>
