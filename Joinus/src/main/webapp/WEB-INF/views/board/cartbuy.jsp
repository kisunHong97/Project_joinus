...
<div class="container">
    ...
    <div class="product-info">
        ...
        <p>이용 기간 : ${productVO.pno}개월</p>
        <p>이용 기간:
            <c:set var="pPeriod" value="${productVO.p_period}" />
            <%
                int pPeriod = (int) pageContext.getAttribute("pPeriod");
                java.util.Calendar cal = java.util.Calendar.getInstance();
                java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy년 MM월 dd일");
                String currentDate = sdf.format(cal.getTime());
                cal.add(java.util.Calendar.MONTH, pPeriod);
